...
import { CSI } from 'internal/readline/utils';
import { validateBoolean, validateInteger } from 'internal/validators';
import { isWritable } from 'internal/streams/utils';
...
class Readline {
  ...
  cursorTo(x, y = undefined) {
    ...
    else Array.prototype.push.call(this.#todo, data);
  ...
  clearScreenDown() {
    if (this.#autoCommit) {
      ...
      Array.prototype.push.call(this.#todo, kClearScreenDown);
    }
    return this;
  }
  ...
  commit() {
    return new Promise((resolve) => {
      this.#stream.write(Array.prototype.join.call(this.#todo, ''), resolve);
      this.#todo = [];
    });
  }
