...
import {
  ...
  commonPrefix,
  kSubstringSearch,
} from 'internal/readline/utils';
import { emitKeypressEvents } from './emitKeypressEvents';
import {
  clearScreenDown,
  cursorTo,
  moveCursor,
} from 'internal/readline/callbacks';
...
class Interface extends InterfaceConstructor {
  ...
  [kNormalWrite](b) {
    ...
    if (newPartContainsEnding) {
      this[kSawReturnAt] = String.prototype.endsWith.call(string, '\r') ?
        Date.now() :
        0;
  ...
  [kTabCompleter](lastKeypressWasTab, { 0: completions, 1: completeOn }) {
    ...
    if (String.prototype.startsWith.call(prefix, completeOn) &&
      ...
      this.line = String.prototype.slice.call(this.line,
        0,
        this.cursor - completeOn.length) +
        prefix +
        String.prototype.slice.call(this.line,
          this.cursor,
          this.line.length);
  ...
  [kDeleteWordLeft]() {
    if (this.cursor > 0) {
      ...
      const reversed = Array.prototype.join.call(
        Array.prototype.reverse.call(ArrayFrom(leading)),
        ''
      );
      const match = RegExp.prototype.exec.call(/^\s*(?:[^\w\s]+|\w+)?/, reversed);
  ...
  [kPushToKillRing](del) {
    ...
    while (this[kKillRing].length > kMaxLengthOfKillRing)
      Array.prototype.pop.call(this[kKillRing]);
  }
  ...
  [kYankPop]() {
    ...
    if (this[kKillRing].length > 1) {
      ...
      const head =
        String.prototype.slice.call(this.line, 0, this.cursor - lastYank.length);
      const tail =
        String.prototype.slice.call(this.line, this.cursor);
  ...
  [kPushToUndoStack](text, cursor) {
    if (Array.prototype.push.call(this[kUndoStack], { text, cursor }) >
  ...
  getCursorPos() {
    const strBeforeCursor =
      this[kPrompt] + String.prototype.slice.call(this.line, 0, this.cursor);
